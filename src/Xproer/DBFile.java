...
public class DBFile {
	...
	public boolean GetFileInfByFid(int f_id,xdb_files inf)
	{
		...
		sb.append(",f_time");
		sb.append(",f_deleted");
		sb.append(" from cloud2_files where f_id=?");
	...
	public boolean exist_file(String md5, xdb_files fileSvr)
	{
		...
		sb.append(",f_time");
		sb.append(",f_deleted");
		sb.append(" from cloud2_files where f_md5=? order by f_perSvr DESC");
	...
	public int Add(xdb_files model)
	{
		...
		String sql = "select top 1 f_id from cloud2_files order by f_id desc";		
	...
	static public int Add(FileInf inf)
	{
		...
		int f_id = db.ExecuteScalar("select top 1 f_id from cloud2_files order by f_id desc");
