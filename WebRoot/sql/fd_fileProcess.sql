...
BEGIN
	...
	--更新文件进度
    SET @sql=N'update cloud2_files set f_pos=@f_pos,f_lenSvr=@lenSvr,f_perSvr=@perSvr,f_complete=@complete where f_uid=@uid and f_id=@idSvr'
	...
	--更新文件夹进度
	SET @fd_sql = N'update cloud2_files set f_lenSvr=@fd_lenSvr,f_perSvr=@fd_perSvr where f_uid=@uid and f_id=@fd_idSvr'
